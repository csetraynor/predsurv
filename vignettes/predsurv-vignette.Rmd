...
uni.brier_score = fun_test(obj = mod.uni,  pred = "Brier", time = os_months, status = os_deceased)
plot_brier(uni.brier_score)
```

Calculate the c-index:
```{R}
uni.c_index = fun_test(obj = mod.uni,  pred = "c_index", status = os_deceased, time = os_months)
print(uni.c_index)
```

```{r}
uni.roc = fun_test(obj = mod.uni, pred = "ROC",  status = os_deceased, time = os_months)
