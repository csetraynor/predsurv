...
```
Because this is a  simulated dataset we can skip various steps of data manipulation, and create a test and training splits. We will use a function of the package survdata.
```{r}
